    ...
    if (null === atn.id) {
      ...
      if (SkeletonAnnotations.TYPE_NODE === atn.type) {
        ...
        if (e.shiftKey) {
          ...
          statusBar.replaceLast("Created connector with " + synapse_type +
        ...
        statusBar.replaceLast("Created treenode #" + atn.id +
    ...
    if (SkeletonAnnotations.currentmode === SkeletonAnnotations.MODES.SKELETON) {
      if (SkeletonAnnotations.TYPE_NODE === atn.type || null === atn.id) {
        ...
        if (null !== atn.id) {
          ...
          atn.promise().then((function(atnId) {
            statusBar.replaceLast("Created new node as child of node #" + atnId);
